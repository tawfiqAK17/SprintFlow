...
public class TaskService {
    ...
    public List<TaskMetaDataResponseDto> getAllTasks(Long sprintId, Long userStoryId, List<TaskStatus> statusList,
                                                     String developer, String tester){
    ...
    public List<TaskMetaDataResponseDto> getCurrentUserTasks(Long sprintId, Long userStoryId, List<TaskStatus> statusList){
        ...
        spec = spec.and( TaskSpecification.assignedToTester( username)
    ...
    public TaskDetailsResponseDto getTask( Long taskId){
        ...
        if( !task.getDeveloper().getUsername().equals(username) && !task.getTester().getUsername().equals(username) && !roles.contains( Role.SCRUM_MASTER)){
    ...
    public void updateTaskDetails( Long taskId, TaskRequestDto dto){
        TaskTransitionStrategy strategy = taskTransitionStrategyHandler.getStrategy( List.of(Role.SCRUM_MASTER));
